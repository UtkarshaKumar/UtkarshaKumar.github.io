...
and the latest few rows into index.html.
  ...
  <nav id="top">
    <div class="nav-inner">
      <div class="nav-brand-group">
        ...
        <span class="nav-role">Bengaluru, India</span>
      </div>
      <div class="nav-links">
    ...
    <div id="mobile-menu">
      <div class="mobile-role">Bengaluru, India</div>
...
# How many recent posts to teaser on the homepage (full list stays on writing.html).
...
def main():
    ...
    if merged:
        ...
        latest_block = "\n".join(render_row(it) for it in merged[:HOMEPAGE_LATEST_COUNT])
    else:
